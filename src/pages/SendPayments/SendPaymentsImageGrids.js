...
import SignUp from '../PayOnline/HiddenCosts'
import HiddenCosts from '../../pages/PayOnline/HiddenCosts'

const SendPaymentsImageGrids = () => {
  return (
    <>
...
export default SendPaymentsImageGrids